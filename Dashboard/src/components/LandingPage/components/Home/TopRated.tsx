...
//     <section ref={sectionRef} className="pt-14 md:pb-10 relative overflow-hidden bg-gray-50 rounded-t-2xl">
    ...
    <div className="w-full min-h-full bg-gradient-to-b from-[#080D1A] via-gray-900 to-gray-50 px-4 sm:px-6 lg:px-8">
      <section ref={sectionRef} className="pt-14 md:pb-10 relative overflow-hidden bg-gray-50 rounded-t-2xl">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between mb-16 gap-8">
            ...
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              <p className="text-sm md:text-xl text-gray-600 leading-relaxed mb-6">
                Explore expert-designed AI courses with smart learning paths tailored to your goals.
              </p>
              <div className="hidden lg:flex flex-col gap-4 bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg">
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500" />
                  <span className="font-medium">Hands-on projects with real-world applications</span>
                </div>
                <div className="flex items-center gap-3">
                  <Users className="w-5 h-5 text-blue-500" />
                  <span className="font-medium">Join a community of 50,000+ learners</span>
                </div>
                <div className="flex items-center gap-3">
                    ...
                    >
                      <div className="flex">
                        ...
                        <div className="w-2/3 p-6">
                          ...
                          <p className="text-sm font-medium text-blue-600 mb-4">{mappedCourse.subtitle}</p>
                          ...
                          <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm">{mappedCourse.totalHours}</span>
                            </div>
                            <div className="flex items-center gap-2">
                              <Users className="w-4 h-4 text-gray-500" />
                              <span className="text-sm">{mappedCourse.students} students</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="w-1/3 relative">
                          ...
                          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                            <div className="flex items-center justify-between">
                              <div className="text-2xl font-black text-white">₹{mappedCourse.price}</div>
                              {mappedCourse.originalPrice && (
                                <div className="text-sm text-white/70 line-through">{mappedCourse.originalPrice}</div>
                              )}
                            </div>
                            <button
                              className="w-full mt-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:shadow-lg transform hover:scale-105 transition-all duration-300 text-white py-2 px-4 rounded-lg font-semibold flex items-center justify-center text-sm"
                              onClick={() => alert('Proceed to enrollment...')}
                            >
          ...
          {/* Mobile Carousel (keep existing implementation) */}
          <div className="lg:hidden mb-16 mx-auto">
            {/* ... (keep existing mobile carousel code) ... */}
          </div>
        </div>
      </section>
    </div>
