  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('https://i.pinimg.com/1200x/e0/df/82/e0df82d1d992ef040ad6052e3c569ec8.jpg')",
      ...
      >
        {/* Top Section */}
        <div>
          <p className="text-sm opacity-75 mb-6">Our partners</p>
        </div>  

        {/* Bottom Section */}
        <div>
          <p className="text-sm opacity-90 mb-6">You can easily</p>
     ...
     {/* Mobile Header - Only visible on small screens */}
      <div className=" absolute lg:hidden text-center h-full w-full">
        ...
        style={{
          ...
          <div className="-mt-16 text-gray-100 -ml-10 text-left">
      ...
      <div className="absolute bg-white bottom-0 md:-top-1/2 mt-80 rounded-t-3xl w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-xl">
          {/* Form Header */}
          <div className="mb-8">
            <h2 className="text-2xl md:text-5xl font-bold text-gray-900 mb-2">Become Instructor  Now</h2>
