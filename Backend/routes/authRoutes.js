...
import { register, login, logout, changePassword, getUserDetails, getAllAdmins, upgradeRole, updateUserInfo, deleteSubadmin, syncAuth0User, assignRole } from '../controllers/authController.js';
...
router.post('/upgrade-role', verifyAuth0Token, upgradeRole);
